...
class Checker:
	...
	class Position:
		...
		Traceback (most recent call last):
			...
		TypeError: Can't get the index of an abstract Checker.Position! You should check for this case!
		...
		@property
		def debug_str(self):
			return self._label or self._value

		@property
		def index(self) -> int:
			if not self.is_concrete:
				raise TypeError("Can't get the index of an abstract Checker.Position! You should check for this case!")
